...
class LinearWeightedRegression():
    """
    Linear weighted regression implementation.
    """
    ...
    def fit(self, X, t, A):
        """
        Fits the linear weighted regression model.

        Parameters
        ----------
        X : Array of shape [n_samples, n_features]
        t : Array of shape [n_samples, 1]
        A : A diagonal array of weights of shape [n_samples, n_samples]
        """        
