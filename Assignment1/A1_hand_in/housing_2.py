...
# Root-Mean-Square Error function (Same as in housing_1.py)
def RMSE(t,tp):
...
# Computing the RSME values for 1 feature and all features
RMSE(t_test, pred_single)
RMSE(t_test, pred_all)

# Displays the plot for true house prices vs estimates with one feature
x_single = t_test
...
# Displays the plot for true house prices vs estimates with all features
x_all = t_test
y_all = pred_all
