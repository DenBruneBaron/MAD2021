...
X_train, t_train = loaddata('D:\\Uddannelse\\Datalogi\\KU\\2_aar\\MAD\\MAD2021\\2022_Exam\\Exam_REPLACEMENT\\exam_data_replacement\\data\\accent-mfcc-data_shuffled_train.txt')
#X_train, t_train = loaddata('./data/accent-mfcc-data_shuffled_train.txt')

# Loads the validation data
X_validation, t_validation = loaddata('D:\\Uddannelse\\Datalogi\\KU\\2_aar\\MAD\\MAD2021\\2022_Exam\\Exam_REPLACEMENT\\exam_data_replacement\\data\\accent-mfcc-data_shuffled_validation.txt')
#X_validation, t_validation = loaddata('./data/accent-mfcc-data_shuffled_validation.txt')
